                ...
                <Grid container spacing={0}>
                    <Grid item md={6} xs={12}>
                        <div className="claim-dialog-form">
                            ...
                            <p style={style.selectLabel}>Cas est vulnérable nécessitant un prélévement ou cas urgent
                                nécessitant une intervention
                                médical imminente ?</p>
                            <InputLabel id="select-flag-label">
                                Rediriger vers SAMUS
                            </InputLabel>
                            <Select
                                labelId="select-flag-label"
                                className="select-response"
                                label="Rediriger vers SAMUS"
                                open={openRedirect}
                                onClose={() => setOpenRedirect(false)}
                                onOpen={() => setOpenRedirect(true)}
                                value={flag}
                                onChange={(event) => setFlag(event.target.value)}
                            >
                                <MenuItem value={"SUSPECT"}>
                                    <span>Dossier Suspect</span>
                                    <span style={{...style.dot, backgroundColor: "#e2833b"}}></span>
                                </MenuItem>
                                <MenuItem value={"URGENT"}>
                                    <span>Dossier Urgent</span>
                                    <span style={{...style.dot, backgroundColor: "#e23b83"}}></span>
                                </MenuItem>
                            </Select>
                            <Divider/>
